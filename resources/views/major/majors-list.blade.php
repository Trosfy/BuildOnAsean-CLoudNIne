...
@section('content')         
<div class="container-100vh d-flex justify-content-center align-content-center align-items-center pHeader" style="background-image: url({{asset('storage/assets/bg-3.svg')}});">
    ...
    <div class="textContainer">
        ...
        <div class="buttonsContainer">
            <button class="btn btn-primary">Start major assessment <img src="{{asset('storage/assets/icons/arrow.svg')}}" alt="" class="icon filter-white"></button>
        </div>
    </div>
</div>

<div class="container-200vh d-flex p2">
    <div class="left p2">
        <span>Filters</span>
